  ...
  function rollWildcard() {
    ...
    const pool = [
      ...
      },
      {
        ...
        tagLabel: 'Open source',
        title: 'ludami',
        desc: 'An opinionated scaffolding kit for Progressive Web Apps — React, TypeScript, Vite, Tailwind. The repo I clone every time I start something new.',
        descPt: 'Kit opinativo de scaffolding para Progressive Web Apps — React, TypeScript, Vite, Tailwind. O repo que clono toda vez que começo algo novo.',
        stack: 'React · TypeScript · Vite · Tailwind · vite-plugin-pwa',
        href: 'https://github.com/Andrade020/ludami',
      },
      {
        tag: 'open',
        tagLabel: 'Open source',
